"""
Defines a trie data structure and functions to create and search it. This data
structure is central to the implementation of a fast tokenizer for GQL queries.
"""
...
def new_trie(keywords: t.Iterable[t.Sequence[t.Hashable]], trie: dict | None = None) -> dict:
    """
    ...
    character strings, or by 0, which is used to designate that a keyword is in the
    trie.
...
def in_trie(trie: dict, key: t.Sequence[t.Hashable]) -> tuple[TrieResult, dict]:
    """
