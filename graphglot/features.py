...
CY_CL06 = _cy("CY:CL06", "Expression-valued SKIP/LIMIT")
CY_CL07 = _cy("CY:CL07", "Implicit GROUP BY for aggregation")
CY_CL09 = _cy("CY:CL09", "DISTINCT ORDER BY on projected properties")
...
CY_OP05 = _cy("CY:OP05", "Polymorphic + operator (string/list concat)")
